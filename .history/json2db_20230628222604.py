...
with open("quotes.json", "r", encoding="utf-8") as quotes:
    ...
    for quote in data:
        quo_i = Quote()
        quo_i.fullname = author["fullname"]
        quo_i.born_date = datetime.strptime(author["born_date"], "%B %d, %Y")
        quo_i.born_location = author["born_location"]
        quo_i.description = author["description"]
        quo_i.save()
